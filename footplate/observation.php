		...
		<div class="panel-body" align="center">
				...
				<table>
					...
					<tr id="clr1">
						...
						<td><input type="number" id="obs1" name="obs1" class="form-control" placeholder="0-10"  min="0" max="10" <?php if($id_set==1) echo "value='$bct'";  ?>></td>
					</tr>
					<tr id="clr1">
						<th>2.</th>
						<th>Brake feel test</th>
						<td><input type="number" id="obs2" name="obs2" class="form-control" placeholder="0-10"  min="0" max="10" <?php if($id_set==1) echo "value='$bft'";?>/></td>
					</tr>
					<tr id="clr1">
						<th>3.</th>
						<th>Brake power test</th>
						<td><input type="number" id="obs3" name="obs3" class="form-control" placeholder="0-10"  min="0" max="10" <?php if($id_set==1) echo "value='$bpt'";?>/></td>
					</tr>
