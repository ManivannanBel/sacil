...
if(isset($_POST["SaveRecord"]) || isset($_POST['UpdateRecord'])||isset($_POST['modify']) || isset($_POST["DeleteRecord"])){
  ...
  //-------- TO SAVE RECORDS--------
    if(isset($_POST["SaveRecord"])){
      ...
      //observation
                ...
                if($res1){
                    $response_msg = 1;
                    //update the date only if lp is associated to cli
  ...
  //----------------  TO UPDATE THE RECORDS--------------
        ...
        $sql1 = "UPDATE `foot_plate_inspection` SET `date` = '$date', `loco_no` = '$locono', `train_no` = '$trainno',
         `from_station` = '$from', `to_station` = '$to', `lps_name` = '$lpsname', `lps_cms_id` = '$lpscmsid', 
         `safey_cate` = '$safetycat', `alps_name` = '$alpsname', `alps_cms_id` = '$alpscmsid', `departure` = '$departure',
          `arrival` = '$arrival', `bct` = '$bct', `bft` = '$bft', `bpt` = '$bpt',
